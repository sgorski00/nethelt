...
import {PasswordResetConfirmRequest, PasswordResetRequest} from '../models/auth/password-reset-request';
...
export class AuthService {
  ...
  public confirmPasswordReset(request: PasswordResetConfirmRequest, token: string) {
    ...
    return this.httpClient.post<void>(`${this.authUrl}/password-reset/confirm`, request, { params });
  }
