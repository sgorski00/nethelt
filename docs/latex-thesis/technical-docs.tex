...
Z każdym urządzeniem powiązane są operacje sieciowe (\texttt{device\_operations}), określające typ wykonywanej operacji oraz czas między kolejnymi wywołaniami operacji. Możliwe typy operacji sieciowych zdefiniowane są w tabeli \texttt{operation\_types}. Dodatkowo w tej tabeli można przełączać wykrywanie anomalii.
